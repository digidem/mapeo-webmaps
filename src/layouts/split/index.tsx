  ...
  return (
    ...
    >
      <Grid container columns={columns}>
        <Grid xs={grid[0]} bgcolor={gridStylesInternal[0].backgroundColor} color={gridStylesInternal[0].color} sx={{
          minHeight: '100vh',
          overflow: 'hidden'
        }}>
          {children[0] || null}
        </Grid>
        <Grid xs={grid[1]} bgcolor={gridStylesInternal[1].backgroundColor} color={gridStylesInternal[1].color} sx={{
          minHeight: '100vh',
          overflow: 'hidden'
        }}>
          {children[1] || null}
